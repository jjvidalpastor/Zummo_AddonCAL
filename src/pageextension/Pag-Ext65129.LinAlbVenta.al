pageextension 65129 "LinAlbVenta" extends "Posted Sales Shpt. Subform"
{
    layout
    {
    }
            ...
            group(Calidad)
            {
                ...
                action("Crear inspección # control visual")
                {
                    ...
                    begin
                        ...
                        clear(cduNewCalidad);
                        cduNewCalidad.GenerarInspeccionCalidadAlbaran(Rec.TableName, "Document No.", "Line No.", "Sell-to Customer No.", "No.", false, "Variant Code", "Location Code", "Bin Code", "Unit of Measure Code", 0);
                    end;
                }
            }
        }
