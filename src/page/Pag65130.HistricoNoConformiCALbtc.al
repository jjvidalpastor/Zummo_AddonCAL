page 65130 "Histórico No Conformi_CAL_btc"
{
    Caption = 'Histórico No Conformidades', Comment = 'ESP="Histórico No Conformidades"';
    ...
    SourceTableView = SORTING("No. inspección", "No. no conformidad") ORDER(Ascending) WHERE("Estado no conformidad" = FILTER(Terminada));
